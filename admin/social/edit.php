...
<!-- SIDEBAR / ASIDE -->
 ...
 <div class="row mb-2">
 <div class="col-sm-6">
 <h1 class="m-0">Edit Data sosmed</h1>
 </div><!-- /.col -->
 <div class="col-sm-6">
...
<input type="text" 
name="nama_sosmed_post" class="form-control"
 placeholder="Masukan Nama Sosmed" 
value="<?= $nama_sosmed ?>" required>
 </div>
 <div class="form-group">
 <label>Link Sosmed</label>
 
<input type="text" 
name="link_post" class="form-control"
...
<div class="input-group">
 ...
 <input type="file" 
name="icon_post" class="custom-file-input" required>
